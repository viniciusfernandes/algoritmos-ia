...
public class SigmoidGradientDescentNetwork2 extends NeuralNetwork {

	private final UnaryOperator<Matrix> activationDerivativeFunction;

	public SigmoidGradientDescentNetwork2(final UnaryOperator<Matrix> outputFunction, final int[] layersNumber) {
